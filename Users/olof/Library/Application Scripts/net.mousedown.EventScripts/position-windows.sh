...
osascript ~/dev/osandell/set-window-boundaries/set-window-boundaries.applescript Fork primary custom auto 0.59 1 0.205 0
osascript ~/dev/osandell/set-window-boundaries/set-window-boundaries.applescript iTerm primary custom auto 0.47 1 -0.265 0
